...
/**
  ...
  * @retval         none
  */
extern void INS_cali_gyro(float_32 cali_scale[3], float_32 cali_offset[3], uint16_t *time_count);
...
/**
  ...
  * @retval         none
  */
extern void INS_set_cali_gyro(float_32 cali_scale[3], float_32 cali_offset[3]);
...
/**
  ...
  * @retval         INS_quat的指针
  */
extern const float_32 *get_INS_quat_point(void);
...
/**
  ...
  * @retval         INS_angle的指针
  */
extern const float_32 *get_INS_angle_point(void);
...
/**
  ...
  * @retval         INS_gyro的指针
  */
extern const float_32 *get_gyro_data_point(void);
...
/**
  ...
  * @retval         INS_gyro的指针
  */
extern const float_32 *get_accel_data_point(void);
