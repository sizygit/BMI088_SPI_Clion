...
void BMI088_temperature_read_over(uint8_t *rx_buf, float_32 *temperate)
{
...
void BMI088_accel_read_over(uint8_t *rx_buf, float_32 accel[3], float_32 *time)
{
    int16_t bmi088_raw_temp;
...
void BMI088_gyro_read_over(uint8_t *rx_buf, float_32 gyro[3])
{
    int16_t bmi088_raw_temp;
    bmi088_raw_temp = (int16_t)((rx_buf[1]) << 8) | rx_buf[0];
...
float_32 get_BMI088_temperate(void)
{
    uint8_t buf[2];
    float_32 temperate;
...
void get_BMI088_accel(float_32 accel[3])
{
    uint8_t buf[6] = {0, 0, 0, 0, 0, 0};
