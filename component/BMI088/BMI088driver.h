...
extern void BMI088_accel_read_over(uint8_t *rx_buf, float_32 accel[3], float_32 *time);
extern void BMI088_gyro_read_over(uint8_t *rx_buf, float_32 gyro[3]);
extern void BMI088_temperature_read_over(uint8_t *rx_buf, float_32 *temperate);
extern void BMI088_read(float_32 gyro[3], float_32 accel[3], float_32 *temperate);
extern uint32_t get_BMI088_sensor_time(void);
extern float_32 get_BMI088_temperate(void);
extern void get_BMI088_gyro(int16_t gyro[3]);
extern void get_BMI088_accel(float_32 accel[3]);
