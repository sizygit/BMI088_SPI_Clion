...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of BinaryINV */
  osSemaphoreDef(BinaryINV);
  BinaryINVHandle = osSemaphoreCreate(osSemaphore(BinaryINV), 1);
...
/* USER CODE BEGIN Header_BMI088Manage */
/**
* @brief Function implementing the BMI088 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_BMI088Manage */
void BMI088Manage(void const * argument)
{
